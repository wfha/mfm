...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { banner: @advertisement.banner, desc: @advertisement.desc, name: @advertisement.name, target_url: @advertisement.target_url }
    end
  ...
  test "should update advertisement" do
    put :update, id: @advertisement, advertisement: { banner: @advertisement.banner, desc: @advertisement.desc, name: @advertisement.name, target_url: @advertisement.target_url }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
