...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { desc: @coupon.desc, end_at: @coupon.end_at, name: @coupon.name, start_at: @coupon.start_at }
    end
  ...
  test "should update coupon" do
    put :update, id: @coupon, coupon: { desc: @coupon.desc, end_at: @coupon.end_at, name: @coupon.name, start_at: @coupon.start_at }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
