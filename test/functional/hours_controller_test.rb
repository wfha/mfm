...
class HoursControllerTest < ActionController::TestCase
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post :create, hour: { close_at: @hour.close_at, desc: @hour.desc, name: @hour.name, open_at: @hour.open_at }
    end
  ...
  test "should update hour" do
    put :update, id: @hour, hour: { close_at: @hour.close_at, desc: @hour.desc, name: @hour.name, open_at: @hour.open_at }
    assert_redirected_to hour_path(assigns(:hour))
  end
