...
RailsAdmin.config do |config|
  ...
  #     configure :id, :integer 
  #     configure :delivery_type, :string 
  ...
  #     configure :dish, :belongs_to_association 
  ...
  #     configure :dishes, :has_many_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your dish.rb model definition
  ...
  # config.model 'DishChoice' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your dish_choice.rb model definition

  #   # Found associations:

  #     configure :store, :belongs_to_association 
  #     configure :dishes, :has_and_belongs_to_many_association 
  ...
  #     configure :desc, :string 
  #     configure :store_id, :integer         # Hidden 
  #     configure :must, :boolean 
  #     configure :checked, :integer 
  ...
  # config.model 'DishFeature' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your dish_feature.rb model definition
  ...
  #     configure :name, :string 
  #     configure :desc, :string 
  #     configure :open_at, :string 
  #     configure :close_at, :string 
  #     configure :store_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  # config.model 'PaypalNotification' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your paypal_notification.rb model definition
